...
import com.ml.entity.UserInfo;
import com.ml.uilts.JwtUtils;
import com.ml.uilts.MenuTree;
import com.ml.uilts.Result;
import com.ml.vo.RouterVo;
import com.ml.vo.TokenVo;
...
public class SysUserController {
    ...
    public Result getInfo() {
        ...
        //获取角色权限编码字段
        Object[] roles =
                permissionList.stream().filter(Objects::nonNull).map(Permission::getCode).toArray();
        //创建用户信息对象
